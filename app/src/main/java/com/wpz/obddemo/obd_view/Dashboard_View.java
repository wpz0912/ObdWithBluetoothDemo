package com.wpz.obddemo.obd_view;
...
public class Dashboard_View extends View {
    ...
    public Dashboard_View(Context context) {
        this(context, null);
    }

    public Dashboard_View(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public Dashboard_View(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);

        TypedArray a = context.obtainStyledAttributes(attrs, R.styleable.Dashboard_View, defStyleAttr, 0);

        mRadius = a.getDimensionPixelSize(R.styleable.Dashboard_View_radius, dpToPx(80));
        mStartAngle = a.getInteger(R.styleable.Dashboard_View_startAngle, 180);
        mSweepAngle = a.getInteger(R.styleable.Dashboard_View_sweepAngle, 180);
        mBigSliceCount = a.getInteger(R.styleable.Dashboard_View_bigSliceCount, 10);
        mSliceCountInOneBigSlice = a.getInteger(R.styleable.Dashboard_View_sliceCountInOneBigSlice, 5);
        mArcColor = a.getColor(R.styleable.Dashboard_View_arcColor, Color.WHITE);
        mMeasureTextSize = a.getDimensionPixelSize(R.styleable.Dashboard_View_measureTextSize, spToPx(12));
        mTextColor = a.getColor(R.styleable.Dashboard_View_textColors, mArcColor);
        mHeaderTitle = a.getString(R.styleable.Dashboard_View_headerTitle);
        if (mHeaderTitle == null) mHeaderTitle = "";
        mHeaderTextSize = a.getDimensionPixelSize(R.styleable.Dashboard_View_headerTextSize, spToPx(14));
        mHeaderRadius = a.getDimensionPixelSize(R.styleable.Dashboard_View_headerRadius, mRadius / 3);
        mPointerRadius = a.getDimensionPixelSize(R.styleable.Dashboard_View_pointerRadius, mRadius / 3 * 2);
        mCircleRadius = a.getDimensionPixelSize(R.styleable.Dashboard_View_circleRadius, mRadius / 17);
        mMinValue = a.getInteger(R.styleable.Dashboard_View_minValue, 0);
        mMaxValue = a.getInteger(R.styleable.Dashboard_View_maxValue, 100);
        mRealTimeValue = a.getFloat(R.styleable.Dashboard_View_realTimeValue, 0.0f);
        mStripeWidth = a.getDimensionPixelSize(R.styleable.Dashboard_View_stripeWidth, 0);
        mModeType = a.getInt(R.styleable.Dashboard_View_stripeMode, 0);
        mBgColor = a.getColor(R.styleable.Dashboard_View_bgColor, 0);
